...
| R2 | runtime 生命周期 + 终端 PTY 远程流（含 resize 带内化） | **会话面完成待手测**（R2a/b/c-lite 落地；R2c 续批：runtime 16 点路由 + lease 降级 + G2；e2e 命令输出时序待手测轮查） | [r2-remote-sessions.md](r2-remote-sessions.md) |
